angular.module('WifiServices', [])
    ...
    function Wificonfig(wifi_ssid,password){ 
      var wifiConfiguration = WifiWizard.formatWifiConfig(wifi_ssid, password, 'WPA');
        
      WifiWizard.addNetwork(wifiConfiguration, win_wifi, fail_wifi);
    }
    ...
    window.setTimeout(function(){
      ...
      addToWifi: function(name,password){
		  	Wificonfig(name,password);
		  }
		};
	});